...
<div class="row page-titles">
    <div class="col-md-5 align-self-center">
        <h4 class="text-themecolor">Trucks</h4>
    </div>
    <div class="col-md-7 align-self-center text-right">
        <div class="d-flex justify-content-end align-items-center">
            ...
            <button type="button" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New Truck</button>
        </div>
    </div>
</div>
<div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                        <h4 class="card-title">View Trucks</h4>
                             @if (session('status'))
                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                            ...
                                            <td class="text-nowrap">
                                             ...
                                             <td class="text-nowrap">
                                             <form action="{{ action('TruckController@destroy',$truck->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
