        ...
        <div class="card">
            <div class="card-body">
                ...
                <h6 class="card-subtitle"></a></h6>
                    ...
                    @endif
                    <form method="post" action="{{ url('trucks') }}">
                         @csrf                              
                                <!-- Text input-->
                                <div class="form-group {{ $errors->has('number') ? ' is-invalid' : '' }}">
                                    <label class="col-md-5 control-label" for="Phone1">Number</label>  
                                    <div class="col-md-5">
                                    <input id="number" name="number" type="text" placeholder="GT876GR" value="{{ old('number') }}" class="form-control input-md">
                                 ...
                                 <div class="form-group {{ $errors->has('type') ? ' is-invalid' : '' }}">
                                        <label class="col-md-5 control-label" for="phone2">Type</label>  
                                        <div class="col-md-5">
                                        <input id="type" name="type" type="text" placeholder="Roll-off" value="{{ old('type') }}" class="form-control input-md">
                                ...
                                <div class="form-group {{ $errors->has('remarks') ? ' is-invalid' : '' }}">
                                    <label class="col-md-5 control-label" for="address">Remarks</label>  
                                    <div class="col-md-5">
                                    <input id="address" name="address" type="text" placeholder="In Good state" value="{{ old('remarks') }}" class="form-control input-md">
