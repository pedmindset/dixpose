                    ...
                    <form method="post" action="{{ action('SupervisorController@update', $supervisor->id) }}">
                         ...
                         @method('PUT')
                            ...
                            <div class="form-group {{ $errors->has('drivers') ? ' is-invalid' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                    <input id="Driver" name="name" type="text" placeholder="Name" class="form-control input-md" value="{{ $supervisor->name or ''}}" required="">
                                ...
                                <div class="form-group {{ $errors->has('phone1') ? ' is-invalid' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                    <input id="Phone1" name="phone1" type="text" placeholder="Phone 1" value="{{ $supervisor->phone1 or ''}}" class="form-control input-md">
                                 ...
                                 <div class="form-group {{ $errors->has('phone2') ? ' is-invalid' : '' }}">
                                        ...
                                        <div class="col-md-4">
                                        <input id="phone2" name="phone2" type="text" placeholder="Phone 2" value="{{ $supervisor->phone2 or ''}}" class="form-control input-md">
                                        <span class="help-block">Enter Supervisor's Phone</span>  
                                        </div>
                                    </div>
                                ...
                                <div class="form-group {{ $errors->has('address') ? ' is-invalid' : '' }}">
                                    ...
                                    <div class="col-md-4">
                                    <input id="address" name="address" type="text" placeholder="Address" value="{{ $supervisor->address or ''}}" class="form-control input-md">
