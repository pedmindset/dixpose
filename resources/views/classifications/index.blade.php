...
@section('title', 'View Classification')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                        <h4 class="card-title">View Classification</h4>
                                ...
                                <tbody>
                                    ...
                                    <tr>    
                                            ...
                                            <td class="text-nowrap">
                                             ...
                                             <td class="text-nowrap">
                                             <form action="{{ action('ClassificationController@destroy',$classification->id) }}" method="POST">
                                                    @csrf
                                                    @method('DELETE')
