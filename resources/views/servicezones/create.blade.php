...
@section('title', 'Create Service Zones')
...
<div class="row">
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title">Add Service Zones</h4>
                <h6 class="card-subtitle"></a></h6>
                    ...
                    <form method="post" action="{{ url('servicezones') }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" id="name" name="name" value="{{ old('name') }}" placeholder="Enter Service Zone Name" required data-validation-required-message ="Please Enter the Zone Name">
                            </div>
                            <div class="form-group">
                                <label class="control-label">Zone<span class="text-danger">*</span></label>
                                    <select name="zone" class="form-control custom-select {{ $errors->has('zone') ? ' is-invalid' : '' }}" required data-validation-required-message ="Please Enter the Zone Name">
